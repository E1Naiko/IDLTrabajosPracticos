...
--altfp_compare CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV GX" PIPELINE=3 WIDTH_EXP=8 WIDTH_MAN=23 aeb clock dataa datab
...
--synthesis_resources = lpm_compare 4 reg 17 
 ...
 ENTITY  altfp_compare0_altfp_compare_tbb IS 
	 PORT 
	 ( 
		 aeb	:	OUT  STD_LOGIC;
		 clock	:	IN  STD_LOGIC;
 ...
 END altfp_compare0_altfp_compare_tbb;

 ARCHITECTURE RTL OF altfp_compare0_altfp_compare_tbb IS
 ...
 END RTL; --altfp_compare0_altfp_compare_tbb
--VALID FILE
...
ARCHITECTURE RTL OF altfp_compare0 IS
	...
	COMPONENT altfp_compare0_altfp_compare_tbb
	PORT (
			aeb	: OUT STD_LOGIC ;
			clock	: IN STD_LOGIC ;
			dataa	: IN STD_LOGIC_VECTOR (31 DOWNTO 0);
...
BEGIN
	...
	altfp_compare0_altfp_compare_tbb_component : altfp_compare0_altfp_compare_tbb
	PORT MAP (
		clock => clock,
		dataa => dataa,
		datab => datab,
